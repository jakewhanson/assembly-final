...
; Configure I/O
     ...
     ; stepper motor I/O
     sbi  DDRD,DDD4                ; make D4 output
     cbi  PORTD,PD4                ; off by default

     sbi  DDRD,DDD5                ; make D5 output
     cbi  PORTD,PD5                ; off by default

     sbi  DDRD,DDD6                ; make D6 output
     cbi  PORTD,PD6                ; off by default

     sbi  DDRD,DDD7                ; make D7 output
     cbi  PORTD,PD7                ; off by default
...
; SLOW MODE (PORTD PD2)
EX0_ISR_Slow:
     ldi  r23,0b00000010                     ; PORTB PB1 is the only pin turned on
     out  PORTB,r23                          ; turn off PORTB Pin 0, turn on PORTB Pin 1 (slow mode)
     call T1Normal                           ; 4 second delay
     ldi  r23,0b00000001                     ; turn on PORTB Pin 0, turn off PORTB Pin 1
     out  PORTB,r23
     reti

; FAST MODE (PORTD PD3)
EX1_ISR_Fast:
     ldi  r23,0b00000100                     ; PORTB PB2 is the only pin turned on
     out  PORTB,r23                          ; turn off PORTB Pin 0, turn on PORTB Pin 2 (fast mode)
     call T1Normal                           ; 4 second delay
     ldi  r23,0b00000001                     ; turn on PORTB Pin 0, turn off PORTB Pin 2
     out  PORTB,r23
     reti
